...
'Deze module bevat het zoek venster.
Option Explicit
...
Dim SelectieV As Long
   ...
   SelectieV = GegevensVenster.ItemsLijst.Selectie()
   ...
   If Gevonden Then
      ...
      GegevensVenster.ZOrder
      GegevensVenster.ItemsLijst.BovensteItem = SelectieV
      GegevensVenster.ItemsLijst.Selectie = SelectieV
...
Dim Keuze As Long
   ...
   If DataBron Is Klanten Then
      DataBronVeld.ListIndex = DbKlanten
   ElseIf DataBron Is Voorraad Then
      DataBronVeld.ListIndex = DbVoorraad
   End If
